...
class DataPernikahanController extends Controller
{
    ...
    //     // Ambil nama desa dari wilayah_id
    //     $wilayah = DataWilayah::find($validateData['wilayah_id']);

    //     if (!$wilayah) {
    //         return back()->with('error', 'Wilayah tidak ditemukan.');
    //     }

    //    $data = [
    //     'umur_suami' => $validateData['usia_suami'],
    //     'umur_istri' => $validateData['usia_istri'],
    //     'pendidikan_suami' => $validateData['pendidikan_suami'],
    //     'pendidikan_istri' => $validateData['pendidikan_istri'],
    //     'pekerjaan_suami' => $validateData['pekerjaan_suami'],
    //     'pekerjaan_istri' => $validateData['pekerjaan_istri'],
    //     'status_suami' => $validateData['status_suami'],
    //     'status_istri' => $validateData['status_istri'],
    //     'nama_kelurahan' => $wilayah->desa,
    //    ];


    //     // Klasifikasi
    //     $klasifikasi = Http::post('http://127.0.0.1:5000/predict', $data);
    //     $hasil_klasifikasi = $klasifikasi->json();

    //     if(!$hasil_klasifikasi){
    //         return back()->with('error', 'Hasil klasifikasi tidak ditemukan.');
    //     }
    //     // Simpan data (bisa tambahkan hasil klasifikasi juga jika perlu)
    //     $pernikahan = DataPernikahan::create($validateData);

    //     //Simpan data (hasil klasifikasi)
    //     $hasil = [
    //         'id_pernikahan' => $pernikahan->id,
    ...
    //     HasilKlasifikasi::create($hasil);




    //     $periode = DataPernikahan::max('tanggal_akad');
    //     $idWilayah = $validateData['wilayah_id'];

    //     // Hitung jumlah seluruh pernikahan di wilayah dan periode saat ini
    //     $jumlahPernikahan = DataPernikahan::where('wilayah_id', $idWilayah)
    //         ->whereYear('tanggal_akad', $periode)
    //         ->count();

    //     // Hitung jumlah pernikahan dini dari hasil klasifikasi
    ...
    //                   ->whereYear('tanggal_akad', $periode);
    //         })
    //         ->where('kategori_pernikahan', 'Pernikahan Dini')
    //         ->count();


    //         $persentase= 0;
    //         if($jumlahPernikahan != 0){
    //             $persentase = ($jumlahPernikahanDini / $jumlahPernikahan) * 100;
    //         }
    ...
    //         // Simpan data ke tabel resiko_wilayah
    //         $resikoWilayah = [
    ...
    //        Resiko_Wilayah::create($resikoWilayah);
